...
var rapidFireShooting = false;
var powerupSpawnTimer = 1;
...
var rapidFirePowerup = {
	...
	width: 25,
	height: 25,
	x: rand(50, SCREEN_WIDTH - 50),
	y: rand(50, SCREEN_HEIGHT - 50),
	isActive: false
};
rapidFirePowerup.image.src = "assets/rapidfirepower.png";
//~planned~

//spawn powerups
function spawnPowerup()
{
	//select which powerup to spawn
	var type = rand(0,3);
	//spawn powerups
...
function onKeyDown(event)
{
	...
	{
		if(rapidFirePowerup.isActive === false)
		{	
			shooting();
		}
		else
...
function runGame(deltaTime)
{
	...
	{
		powerupSpawnTimer = 30.0;
		context.drawImage(rapidFirePowerup.image, rapidFirePowerup.x, rapidFirePowerup.y);
	}
		//update shoot timer
	if(shootTimer > 0)
